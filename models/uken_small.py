...
class UNet3DWithKEM(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, base_n_filter=4, ncodes=8):
        ...
        # Bottleneck with KEM
        self.bottleneck = ResBlock3D(base_n_filter * 2, base_n_filter * 4)
        self.kem = EmbeddingModule3D(base_n_filter * 4, ncodes=ncodes)
